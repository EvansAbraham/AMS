    ...
    <div className="bg-gray-50 flex flex-col min-h-screen p-4 pt-16 sm:hidden">
      ...
      <ScrollArea className="flex-grow">
        <div className="space-y-4 max-w-md mx-auto w-full">
          ...
          <div className="flex flex-col">
            <Label htmlFor="raCompletedBy" className="text-sm text-center">
              RA Completed By
            </Label>
            <Input
              id="raCompletedBy"
          ...
          <div className="flex flex-col">
            <Label htmlFor="raCompletedOn" className="text-sm text-center">
              RA Completed On
            </Label>
            <div className="mt-1">
          ...
          <div className="flex flex-col">
            <Label
              htmlFor="remedialCompletedBy"
              className="text-sm text-center"
            >
              Remedial Completed By
            </Label>
            <Input
          ...
          <div className="flex flex-col">
            <Label htmlFor="remedialDoneOn" className="text-sm text-center">
              Remedial Done On
            </Label>
            <div className="mt-1">
